...
class AlertViewController2: UIViewController {
  ...
  private var alertStyle = AlertStyle.light
  ...
  init(title: String, content: String, axis: NSLayoutConstraint.Axis, style: AlertStyle = .light, actions: [Action]) {
  ...
  private func setupUI() {
    ...
    for action in actions {
        let actionButton = ActionButton2(withAction: action)
